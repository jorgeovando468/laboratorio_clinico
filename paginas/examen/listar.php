...
<body>
    <div class="container">
        <div class="main-container">
            <input type="text" id="id_examen" value="0" hidden>
            ...
            <div class="form-section">
                <div class="row g-3">
                    ...
                    <div class="col-md-4">
                        ...
                        <select id="tipo_examen_lst" class="form-select">
                            <option disabled selected value="0">-- Seleccione un tipo de examen --</option>
                        </select>
                    </div>
                    <div class="col-md-4">
                    ...
                    <div class="col-md-6 mt-4">
                        <button class="btn btn-custom btn-save w-100" onclick="guardarExamen();">
                            💾 Guardar Examen
                        </button>
                    </div>
                    <div class="col-md-6 mt-4">
            ...
            <div class="search-section mx-4">
                ...
                <input type="text" id="b_examen" class="form-control" placeholder="Buscar por tipo, paciente, médico, fecha...">
            </div>
