...
<head>
    ...
    <style>
        ...
        /* Input de tipo number con estilo mejorado */
        input[type="number"] {
...
<body>
    <div class="container">
        <div class="main-container">
            <input type="text" id="id_factura" value="0" hidden>
            ...
            <div class="form-section">
                <div class="row g-3">
                    ...
                    <div class="col-md-4">
                        ...
                        <input type="number" class="form-control" id="total" placeholder="0.00" step="0.01" min="0">
                    </div>
                    <div class="col-md-4">
                    ...
                    <div class="col-md-6 mt-4">
                        <button class="btn btn-custom btn-save w-100" onclick="guardarFactura();">
                            💾 Guardar Factura
                        </button>
                    </div>
                    <div class="col-md-6 mt-4">
            ...
            <div class="search-section mx-4">
                <label>Buscar Facturas</label>
                <input type="text" id="b_factura" class="form-control" placeholder="Buscar por paciente, fecha, monto...">
            </div>
