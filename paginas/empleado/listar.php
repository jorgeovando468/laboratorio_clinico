    ...
    <div class="container">
        <div class="main-container">
            ...
            <div class="form-section">
                <div class="row g-3">
                    ...
                    <div class="col-md-6 mt-4">
                        <button class="btn btn-custom btn-save w-100" onclick="guardarEmpleado();">
                            💾 Guardar Empleado
                        </button>
                    </div>
                    <div class="col-md-6 mt-4">
            ...
            <div class="search-section mx-4">
                ...
                <input type="text" id="b_empleado" class="form-control" placeholder="Buscar por nombre, cargo, email...">
            </div>
